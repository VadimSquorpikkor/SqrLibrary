...
public class SaveLoadR {
    ...
    private static String getStringFromResId(int resId) {
        if (getApplicationUsingReflection()==null) return "";
        return getApplicationUsingReflection().getString(resId);
    }

    static SharedPreferences mPrefPrivate = getApplicationUsingReflection().getSharedPreferences("pref", Context.MODE_PRIVATE);
...
//--------------------------------------------------------------------------------------------------
    ...
    static SharedPreferences mPrefManager = PreferenceManager.getDefaultSharedPreferences(getApplicationUsingReflection());
    ...
    public static void savePref(int keyId, String param) {
        String key = getStringFromResId(keyId);
...
//--------------------------------------------------------------------------------------------------
    ...
    public static boolean getPrefBoolean(int resId) {
        String key = getStringFromResId(resId);
    ...
    public static boolean getPrefBoolean(int resId, int defValueId) {
        String key = getStringFromResId(resId);
        boolean defValue = getStringFromResId(defValueId).equals("true");
    ...
    public static int getPrefInt(int resId, int defValueId) {
        String key = getStringFromResId(resId);
        String defValue = getStringFromResId(defValueId);
